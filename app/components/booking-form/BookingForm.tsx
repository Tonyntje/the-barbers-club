...
import BookingModal from "@/app/components/BookingModal/BookingModal";
    ...
    <>
      {isOpen ? (
        <form className="top-slide">
          <div className="fixed right-2 bottom-2 w-full max-w-[96vw] min-w-[200px] rounded-lg border bg-neutral-100 p-4 shadow-2xl sm:right-6 sm:bottom-6 sm:max-w-[450px] sm:p-12">
            <div
              ...
              onKeyDown={() => {}}
              className="absolute top-2 right-2 inline-block cursor-pointer rounded-lg bg-neutral-100"
            >
              <Subtract size={24} />
            </div>
            ...
            {!isDev ? (
              ...
              <div className="top-slide-slow text-center">
                ...
                <div className="flex gap-2 sm:gap-4">
                  <a
                    className="bg-primary-700 hover:bg-primary-600 mt-3 flex items-center justify-center gap-4 rounded-xl px-6 py-2 text-lg text-white transition-colors"
        ...
        <div
          // onClick={() => setBookingStatus(isOpen)}
          // onKeyDown={() => {}}
          className="bg-primary-700 fixed right-12 bottom-6 cursor-pointer rounded-lg px-6 py-3 shadow-2xl"
        >
          <BookingModal triggerText="Reserveer nu" />
          <span className="flex items-center gap-2 text-white"></span>
        </div>
      )}
    </>
  );
